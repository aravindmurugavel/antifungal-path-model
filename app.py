...
# ===========================
st.set_page_config(
    page_title="Personalized Antifungal Treatment Recommendation (PATH)",
    layout="wide",
...
if st.button("Predict Antifungal Treatment", type="primary"):
    ...
    with col2_sum:
        ...
        **Important Disclaimer:**
        - The recommendations generated by PATH (Personalized Antifungal Treatment Recommendation) are intended for clinical decision support only and must not be considered a  final prescription or treatment directive.
